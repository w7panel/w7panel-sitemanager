...
{{/*
Normalize gatewayEnabled so both boolean values and their string forms work.
*/}}
{{- define "tradition-tool.gatewayEnabled" -}}
{{- eq (lower (toString .Values.gatewayEnabled)) "true" -}}
{{- end }}
